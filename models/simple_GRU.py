...
class SimpleGRU(BaseConvRNN):
    ...
    def __init__(self,
        ...
        self.i2h = nn.Conv2d(
            ...
            out_channels=self._num_filter * 3, #這個*3 是把原本32channel變成96
            kernel_size=self._i2h_kernel,      #分別代表GRU裡面reset/update/memory gate的W值
    ...
    def forward(self, 
        ...
        if is_ashesh:
            ...
            if inputs is not None:
                ...
                #print('i2h',i2h.shape) # 6 16 96 24 24 S B C H W
                #print(self._num_filter) #32 這樣會切成三等份
                i2h_slice = torch.split(i2h, self._num_filter, dim=2) #self._num_filter(切成幾份)，dim=往哪個維度切
                #print('0', (i2h_slice[0]).shape) #6 16 32 24 24 #沿著channel切三份 96-> 32[0] 32[1] 32[2]
            ...
            for i in range(seq_len):
                ...
                #print('1',h2h_slice[0].shape) #16 32 24 24
                if inputs is not None:
