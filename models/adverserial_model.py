...
class AdvModel(LightningModule):
    ...
    def generator_loss(self, input_data, target_label):
        ...
        #print(predicted_reconstruction.shape) #3 8 120 120
        #print(target_label.shape) 8 3 120 120
        ...
        recons_loss = nn.BCELoss()(predicted_reconstruction, target_label)
        # train generator
        ...
        tqdm_dict = {'recon_loss': recons_loss}
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        #print(train_data.shape)   8 6 2 120 120 (batch, inp-sequence, rain/radar, x,y)
        #print(train_label.shape)  8 3 120 120 (batch, opt-sequence, x,y)
